...
A recorded `successor=none` with no declared pending attempt stays down under Pi, a recorded successor whose process is gone stays down, and a lost session origin stays down.
